...
import { Search, Plus, Edit, Trash, UserCheck, UserX, Shield, Users, Calendar, Mail, Star } from 'lucide-react';
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          {user.avatar ? (
                            ...
                            <div className="w-10 h-10 rounded-full mr-3 bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold text-sm">
